...
# Add competitions
db.session.add(Competition(session_user.id, "City College Cube Day", "160 Convent Avenue", "New York", "NY", "10031", datetime.date(2017, 12, 31)))
db.session.add(Competition(session_user2.id, "Rubik's Cube Day", "Cubicle", "City", "State", "10009", datetime.date(2017, 12, 31)))
